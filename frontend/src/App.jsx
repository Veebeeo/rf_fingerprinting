        ...
        <div className="lg:col-span-1 flex flex-col space-y-8">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md border border-gray-200">
            ...
            <div className="flex flex-col space-y-4">
                 <button 
                    onClick={() => handleSampleFile('https://media.githubusercontent.com/media/Veebeeo/rf_fingerprinting/main/frontend/public/fast_demo_1_stealth_incursion.npy?download=true', 'fast_demo_1_stealth_incursion.npy')} 
                    disabled={isLoading} 
                 ...
                 <button 
                    onClick={() => handleSampleFile('https://media.githubusercontent.com/media/Veebeeo/rf_fingerprinting/main/frontend/public/fast_demo_2_disruption_attack.npy?download=true', 'fast_demo_2_disruption_attack.npy')} 
                    disabled={isLoading} 
                    className="w-full bg-ocean hover:opacity-90 disabled:bg-gray-400 text-white rounded-lg px-4 py-3 font-bold transition-colors">
                    Load Disruption Demo
                </button>
                <button 
                    onClick={() => handleSampleFile('https://media.githubusercontent.com/media/Veebeeo/rf_fingerprinting/main/frontend/public/fast_demo_real_world_QPSK_test.npy?download=true', 'fast_demo_real_world_QPSK_test.npy')} 
                    disabled={isLoading} 
                    className="w-full bg-ocean hover:opacity-90 disabled:bg-gray-400 text-white rounded-lg px-4 py-3 font-bold transition-colors">
                    Load QPSK Demo
                </button>
